...
namespace Services.Services
{
    public class ProdutoService : IProdutoService
    {
        ...
        public async Task<Resultado<ListProduto>> CreateProdutoAsync(ListProduto entity)
        {
            try
            {
                return Resultado<ListProduto>.ComSucesso(await this.infrastructure.CreateProdutoAsync(entity));
            }
            catch (Exception exception)
            {
